...
<?php 
    ...
    if(isset($_GET["client_id"]) && isset($_GET["opportunity_id"])){
...
<aside class="right-side">                
    ...
    <section class="content-header">
        <h1>
            Completando dados de cliente/atendimento
            <small></small>
        </h1>
        <br/>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">Completando dados de cliente/atendimento</li>
        </ol>
    </section>
    <!-- Main content -->                            
            ...
            <div class="col-xs-12">
                <div class="box box-primary">
                    ...
                    <div class="box-header">
                        <h3 class="box-title">Completando Atendimento e dados do Cliente <?php echo $client->client_name." ".$client->client_surname;?> </h3>
                    </div><!-- /.box-header -->
                    <div class="box-body">
                        <form id="client_form" method="POST" role="form" class="half-form" action="COA_information.php?page=complete&client_id=<?php echo $_GET["client_id"];?>&opportunity_id=<?php echo $_GET["opportunity_id"];?>">
							...
							<div class="form-group">
								<label class="control-label">Resumo (Informação Mínima Essencial do Atendimento)</label>
									<input type="text" class="form-control" id="opportunity_title" value="<?php echo $opportunity->opportunity_title;?>"  name="opportunity_title" placeholder="Resumo (Informação Mínima Essencial do Atendimento)" onfocus="active_autocomplete({id: this.id, target_field: 'opportunity_title', search_field: 'opportunity_title', table: 'digitulus_opportunity'});"  />
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label class="control-label">Notas do Atendimento</label>
                                    <input type="text" class="form-control" id="opportunity_notes" value="<?php echo $opportunity->opportunity_notes;?>" name="opportunity_notes" placeholder="Outras informações"  />
                            </div>
                            <div class="form-group">
...
<script>
    //ativa o calandário
    $( "#opportunity_deal_date" ).datepicker($.datepicker.regional[ "pt-BR" ]);
    $( "#opportunity_deal_date" ).datepicker("setDate", "+0d");
