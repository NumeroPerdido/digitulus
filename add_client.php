                        ...
                        <form id="client_form" method="POST" role="form" class="half-form" action="client_information.php?page=add">
							...
							<div class="form-group">
								<label class="control-label">Sobrenome</label>								 
									 <input type="text" class="form-control" id="client_surname" name="client_surname" placeholder="Sobrenome do Cliente"   />
                            </div>
							<div class="form-group">
                            ...
                            <div class="form-group">
                                <label class="control-label">Outras informações</label>
                                    <input type="text" class="form-control" id="client_other_information" name="client_other_information" placeholder="Outras informações"  />
                            </div>                             
                            <div class="form-group">
