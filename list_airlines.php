<?php
$_SESSION["table"]="digitulus_airline_list";    
?>  
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">Companhias Aereas</h3>                                    
                                </div><!-- /.box-header -->
                                <div class="box-body table-responsive">
                                    <table id="list_airline" class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                <th>Código IATA</th>
												<th>Nome da Linha Aérea</th>
        ...
        <script src="http://ajax.googleapis.com/ajax/libs/jquery/2.0.2/jquery.min.js"></script>
         ...
         <script type="text/javascript">
            ...
            $(document).ready(function() {
                ...
                $('#list_airline tfoot th').each( function () {
                    var title = $('#list_airline thead th').eq( $(this).index() ).text();
                    $(this).html( '<input class="form-control" type="text" placeholder="Buscar '+title+'" />' );
                } );
                
                var cbx;
                var table = $('#list_airline').DataTable( {
                    dom: 'Bfrtip',
//                    dom: 'C<"clear">lfrtip',
                    colReorder: true,
                    buttons: [
                    ...
                    "fnCreatedRow": function( nRow, ajax, iDataIndex ) {
                         ...
                         var qt_col=$('#list_airline thead th').length;
                         qt_col = qt_col -2;
                         //Gera o link para edição na última coluna
						 $('td:eq('+qt_col+')', nRow).html("<a href='index.php?page=Editar-Companhia-Aerea&airline_iata_code="+ajax[0]+"'><i class='fa fa-edit'/> Editar</a>");
						 qt_col ++;
                        $('td:eq('+qt_col+')', nRow).html("<a href='airline_list_information.php?airline_iata_code="+ajax[0]+"&page=delete'     onclick ='return confirm(\"Deseja excluir o registro?\");'><i class='fa fa-times-circle' /> Remover Companhia Aérea</a>");
					},
                    
                } );
                // Aplica o filtro
                $("#list_airline tfoot input").on( 'keyup change', function () {
                    table
                ...
                var j=0;
                $('#list_airline thead th').each( function () {
