...
(function($) { // hide the namespace
	...
	var layoutStandard = ['  BSCECA', '_1_2_3_+@X', '_4_5_6_-@U', '_7_8_9_*@E', '_0_._=_/_%'];
	...
	inst.curValue = inst.prevValue + inst.curValue;
		...
		regionalOptions: { // Available regional settings, indexed by language/country code
			'': { // Default regional settings - English/US
				decimalChar: '.',
				buttonText: '...',
				buttonStatus: 'Abra a calculadora',
				closeText: 'Fechar',
				closeStatus: 'Feche a calculadora',
				useText: 'Usar',
				useStatus: 'Usar o valor atual',
				eraseText: 'Apagar',
				eraseStatus: 'Apagar o valor do text',
				backspaceText: 'BS',
				backspaceStatus: 'Remova o ultimo dígito',
				clearErrorText: 'CE',
				clearErrorStatus: 'Remova o ultimo número',
				clearText: 'CA',
	...
	/* The definitions of the buttons that may appear on the calculator.
	   ...
	   class(es), field name, keystroke, keystroke name. */
		...
		_finished: function(inst, label, value) {
            ...
            //dá focus para o campo assim que fechar a calculadora
            inst._input[0].focus();
