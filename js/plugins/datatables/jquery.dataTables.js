...
(/** @lends <global> */function( $ ) {
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *    } );
			 */
			"sInfo": "Mostrando de _START_ a _END_ no total de _TOTAL_ dados",
			 ...
			 *    } );
			 */
			"sInfoEmpty": "Mostrando de 0 a 0 no total de 0 dados",
			 ...
			 *    } );
			 */
			"sInfoFiltered": "(filtrado no total de _MAX_ dados)",
...
//easteregg para tocar o tema de GoT 8bits ao clicar no mindinho do logo NÃO TEM NADA A VER COM ESSE CÓDIGO
function easteregg(){
        $( "#logo" ).after("<iframe id='easteregg' width='560' height='315' src='https://www.youtube.com/embed/qyCCfJwFh8I?autoplay=1' frameborder='0' hidden='hidden' allowfullscreen>");
}